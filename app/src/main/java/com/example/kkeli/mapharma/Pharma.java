...
public class Pharma {
    ...
    public void setRegion(String region){this._region = region;}

    public String getRegion (){return  this._region;}

    //Town getter and serrter functions
    public void setTown(String town){this._town = town;}

    public  String getTown(){return this._town;}
