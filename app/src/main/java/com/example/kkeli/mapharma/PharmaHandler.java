...
public class PharmaHandler extends SQLiteOpenHelper {
    ...
    public  static final String PHD_COLUMN_NAME = "phdname";
    ...
    private String[] phdColumns = {PHD_COLUMN_ID, PHD_COLUMN_NAME,PHD_COLUMN_START_DATE,PHD_COLUMN_END_DATE,TOWN_COLUNM_ID };
    // Create database
    ...
    private static final String CREATE_TABLE_PHD = "CREATE TABLE " +
            ...
            "("
               + PHD_COLUMN_ID + " TEXT,"
               + PHD_COLUMN_START_DATE +  " DATETIME,"
               + PHD_COLUMN_END_DATE + " DATETIME,"
            +")";
    ...
    // insert Pharma
    public boolean insertPharmaDeGarde(Pharma pharma){
        // Get db writable
        SQLiteDatabase db = this.getWritableDatabase();
        // Get the values to insert
        ContentValues vals = new ContentValues();
